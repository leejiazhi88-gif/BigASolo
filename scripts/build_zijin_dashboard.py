...
STOCKS = [
    ...
    {"code": "688525.SH", "name": "佰维存储"},
    {"code": "001309.SZ", "name": "德明利"},
...
.wrap{width:100%;max-width:1500px;margin:auto;padding:24px 24px 24px 236px;overflow:hidden}.header{display:flex;justify-content:space-between;gap:16px;align-items:flex-end}.header h1{font-size:27px;margin:0 0 6px}.muted{color:var(--muted)}.badge{border:1px solid #284052;border-radius:999px;padding:8px 12px;color:#a8bac8;font-size:12px;white-space:nowrap}
.stock-panel{position:fixed;left:max(16px,calc((100vw - 1500px)/2 + 24px));top:22px;width:190px;max-height:calc(100vh - 44px);z-index:20;overflow:auto;padding:13px;border:1px solid #1d3445;background:#091522f5;border-radius:12px;box-shadow:0 10px 34px #0007;backdrop-filter:blur(8px)}.stock-row{display:grid;gap:16px}.stock-checks,.stock-tabs{display:grid;gap:8px}.stock-check{display:flex;align-items:center;gap:7px;border:1px solid #243847;border-radius:8px;padding:8px 9px;color:#b7c6d2;font-size:12px;background:#0f1d2a}.stock-check input{accent-color:#42d3ff}.stock-tabs button{width:100%;text-align:left}.stock-tabs button.active{background:#42d3ff;border-color:#42d3ff;color:#06111a;font-weight:800}.stock-tabs button:disabled{opacity:.45;cursor:not-allowed}
...
@media(max-width:1200px){.wrap{padding-left:216px}.stock-panel{left:14px;width:184px}.cards{grid-template-columns:repeat(2,minmax(0,1fr))}.grid2{grid-template-columns:1fr}.forecast-grid{grid-template-columns:repeat(3,minmax(0,1fr))}}
@media(max-width:850px){.wrap{padding:13px}.header{align-items:flex-start;flex-direction:column}.stock-panel{position:static;width:auto;max-height:none;margin:12px 0 6px;overflow:visible;box-shadow:none;backdrop-filter:none}.stock-row{display:grid;gap:12px}.stock-checks,.stock-tabs{display:flex;gap:8px;align-items:center;flex-wrap:wrap}.stock-check{border-radius:999px}.stock-tabs button{width:auto;text-align:center}.cards{grid-template-columns:repeat(2,minmax(0,1fr))}.grid2{grid-template-columns:1fr}.forecast-grid{grid-template-columns:1fr}.chart-wrap{height:500px}.small-chart{height:390px}.valuation-main-chart{height:430px}.metric-note,.event-head{flex-direction:column;align-items:flex-start}.event-filters{width:100%}.event-filters select{flex:1}.metric-current{white-space:normal}.navigator{margin:0 18px}.nav{overflow:auto}.nav button{white-space:nowrap}}
